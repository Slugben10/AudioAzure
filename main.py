...
class MainFrame(wx.Frame):
    ...
    def transcribe_thread(self, file_path, language):
        ...
        try:
            ...
            wx.CallAfter(self.set_transcript, self.audio_processor.transcript)
...
"""
    ...
    def create_settings_panel(self):
        """Create the settings panel with Azure OpenAI configuration."""
        settings_sizer = wx.BoxSizer(wx.VERTICAL)
        ...
        chat_deployment_label = wx.StaticText(self.settings_panel, label="Chat Deployment Name:")
        self.chat_deployment_input = wx.TextCtrl(self.settings_panel)
        self.chat_deployment_input.SetValue(self.config_manager.get_azure_deployment("chat"))
        
        whisper_deployment_label = wx.StaticText(self.settings_panel, label="Whisper Deployment Name:")
        self.whisper_deployment_input = wx.TextCtrl(self.settings_panel)
        self.whisper_deployment_input.SetValue(self.config_manager.get_azure_deployment("whisper"))
        ...
        # Language Selection
        lang_label = wx.StaticText(self.settings_panel, label="Language:")
        self.lang_combo = wx.Choice(self.settings_panel, choices=[LANGUAGE_DISPLAY_NAMES[lang] for lang in SUPPORTED_LANGUAGES])
        current_lang = self.config_manager.get_language()
        self.lang_combo.SetSelection(SUPPORTED_LANGUAGES.index(current_lang))
        ...
        settings_sizer.Add(azure_endpoint_label, 0, wx.ALL, 5)
        settings_sizer.Add(self.azure_endpoint_input, 0, wx.EXPAND | wx.ALL, 5)
        settings_sizer.Add(chat_deployment_label, 0, wx.ALL, 5)
        settings_sizer.Add(self.chat_deployment_input, 0, wx.EXPAND | wx.ALL, 5)
        settings_sizer.Add(whisper_deployment_label, 0, wx.ALL, 5)
        settings_sizer.Add(self.whisper_deployment_input, 0, wx.EXPAND | wx.ALL, 5)
        settings_sizer.Add(hf_label, 0, wx.ALL, 5)
        settings_sizer.Add(self.hf_input, 0, wx.EXPAND | wx.ALL, 5)
        settings_sizer.Add(lang_label, 0, wx.ALL, 5)
        settings_sizer.Add(self.lang_combo, 0, wx.EXPAND | wx.ALL, 5)
